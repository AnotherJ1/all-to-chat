// 统一 SVG 图标组件 — 替代 emoji icon
// 基于 Lucide 风格,24x24 viewBox
...
export function IconChat({ className = 'w-5 h-5', style }: IconProps) {
  return (
...
export function IconCompare({ className = 'w-5 h-5' }: IconProps) {
  return (
...
export function IconImage({ className = 'w-5 h-5', style }: IconProps) {
  return (
    <svg className={className} style={style} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
...
export function IconSettings({ className = 'w-5 h-5', style }: IconProps) {
  return (
    <svg className={className} style={style} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
...
export function IconMenu({ className = 'w-5 h-5', style }: IconProps) {
  return (
...
export function IconArrowLeft({ className = 'w-5 h-5', style }: IconProps) {
  return (
    <svg className={className} style={style} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
...
export function IconJson({ className = 'w-5 h-5', style }: IconProps) {
  return (
    <svg className={className} style={style} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 6.75L22.5 12l-5.25 5.25M6.75 17.25L1.5 12l5.25-5.25" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M14 4l-4 16" />
    </svg>
  )
}

export function IconDatabase({ className = 'w-5 h-5', style }: IconProps) {
  return (
    <svg className={className} style={style} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
...
export function IconClock({ className = 'w-5 h-5', style }: IconProps) {
  return (
    <svg className={className} style={style} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
...
export function IconCron({ className = 'w-5 h-5', style }: IconProps) {
  return (
    <svg className={className} style={style} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
...
export function IconDiff({ className = 'w-5 h-5', style }: IconProps) {
  return (
    <svg className={className} style={style} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M8 4v8m-4-4h8M16 17h4M16 6h4M14 17l4-13" />
    </svg>
  )
}
