...
const PROMPT_PRESETS = [
  { label: '人像', prompt: '高端杂志人像摄影，人物正面或三分之二侧脸，眼神有故事感，皮肤纹理自然真实，柔和窗边光或伦勃朗光，浅景深虚化背景，服装与背景色调协调，电影级调色，高清细节' },
  { label: '海报', prompt: '电影级主视觉海报，主体占据画面视觉中心，标题区预留清晰留白，前景中景背景层次分明，强对比光影与氛围色，主标题和副标题排版位置明确，品牌或活动信息区清晰，印刷级细节，高级商业设计感' },
  { label: '宣传图', prompt: '品牌宣传图，核心卖点以大面积视觉焦点呈现，产品或人物与真实场景形成故事画面，干净背景叠加细腻光效，适合朋友圈、小红书、公众号头图传播，信息层级清楚，配色统一，预留文案与 Logo 区域' },
  { label: '广告', prompt: '高转化商业广告图，产品特写清晰锐利，真实材质反光与精致棚拍布光，背景呈现具体使用场景，加入吸引注意的视觉钩子，构图突出核心卖点，画面干净有冲击力，适合电商 Banner 和社媒投放' },
  { label: '活动', prompt: '大型活动主视觉 KV，舞台灯光、彩带、人群氛围或主题装置营造现场感，中心主题醒目，日期地点信息区预留，画面热烈但不杂乱，空间层次丰富，适合海报、横幅和会场大屏' },
  { label: '证件', prompt: '标准证件照，人物正面直视镜头，肩部以上构图，纯色浅灰、蓝色或白色背景，面部光线均匀无硬阴影，五官清晰，发型整洁，表情自然，真实摄影质感，符合正式证件照风格' },
] as const
